...
For each model in the probing subset:
  ...
  2. Extract activations into data/activations/<model>/layer_*.npy.
  3. Train a logistic-regression probe at every layer with 5-fold CV.
  4. Write per-layer accuracies to data/probe_results/<model>/<attr>.json.

Resume-safe per (model, attribute): cells whose JSONs exist are skipped.
"""
