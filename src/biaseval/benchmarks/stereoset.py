"""StereoSet intrasentence benchmark (Nadeem et al. 2021).

Reports LMS, SS, ICAT:
    LMS  fraction of items where a meaningful continuation beats the
         unrelated one.
    SS   among meaningful preferences, fraction where stereo beats anti.
         50 = unbiased.
    ICAT LMS * min(SS, 100 - SS) / 50 -- penalises low-LMS "unbiased" models.
"""
