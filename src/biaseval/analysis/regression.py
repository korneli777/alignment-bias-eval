"""Confound-controlled regression of the variant (base vs instruct) effect.
...
Multiplicity across benchmarks is handled by Holm-Bonferroni on the variant
coefficient.
"""
...
# Headline bias metric per benchmark — used as the outcome variable in
# the per-benchmark regression. Per-category and per-bias-type metrics
# stay in the parquet for downstream analysis.
...
def write_regression_report(
    ...
    from biaseval.analysis.aggregate import aggregate_logit_results
